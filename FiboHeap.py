# Taken from git repository : https://github.com/danielborowski/fibonacci-heap-python
import math
...
class FibonacciHeap:
    ...
    # internal node class
    class Node:
        def __init__(self, key, value, game_node):
            self.key = key
            self.value = value
    ...
    def insert(self, key, value=None, game_node=None):
        n = self.Node(key, value, game_node)
        n.left = n.right = n
